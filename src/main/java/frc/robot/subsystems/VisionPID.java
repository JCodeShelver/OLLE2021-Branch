...
{ 
	...
	// --------------------------------------------------------------------------
	// Toggles the Limelight's camera mode.
	...
	// --------------------------------------------------------------------------
	// Toggles the Limelight's led mode.
	public void lightModeSwitch()
	{
		table.getEntry("ledMode").setNumber(1 - (table.getEntry("ledMode").getDouble(1)));
	}
